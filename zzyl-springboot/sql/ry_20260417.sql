...
insert into sys_menu values('5', '护理管理', '0', '5', 'nursing',          null, '', '', 1, 0, 'M', '0', '0', '', 'care',     'admin', sysdate(), '', null, '护理管理目录');
-- 二级菜单
...
insert into sys_menu values('118',  '护理项目', '5',   '1', 'project',    'nursing/project/index',    '', '', 1, 0, 'C', '0', '0', 'nursing:project:list',    'list',          'admin', sysdate(), '', null, '护理项目菜单');
-- 三级菜单
...
-- 护理项目按钮
insert into sys_menu values('1061', '护理项目查询', '118', '1', '', '', '', '', 1, 0, 'F', '0', '0', 'nursing:project:query',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1062', '护理项目新增', '118', '2', '', '', '', '', 1, 0, 'F', '0', '0', 'nursing:project:add',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1063', '护理项目修改', '118', '3', '', '', '', '', 1, 0, 'F', '0', '0', 'nursing:project:edit',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1064', '护理项目删除', '118', '4', '', '', '', '', 1, 0, 'F', '0', '0', 'nursing:project:remove',     '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1065', '护理项目导出', '118', '5', '', '', '', '', 1, 0, 'F', '0', '0', 'nursing:project:export',     '#', 'admin', sysdate(), '', null, '');
...
create table nursing_project (
  ...
  order_no           bigint(20)      default 0                  comment '排序号',
  ...
  remark             varchar(500)    default ''                 comment '备注',
  primary key (id)
) engine=innodb auto_increment=1 comment='护理项目表';

-- ----------------------------
-- 初始化-护理项目表数据
-- ----------------------------
insert into nursing_project values('1', '助餐', '1', '次', '20.00', '', '要时刻观察老人状态', '1', 'admin', sysdate(), '', null, '');
insert into nursing_project values('2', '助浴', '2', '次', '50.00', '', '要时刻观察老人状态', '1', 'admin', sysdate(), '', null, '');
insert into nursing_project values('3', '康复运动', '3', '40分钟', '100.00', '', '要时刻观察老人状态', '0', 'admin', sysdate(), '', null, '');
insert into nursing_project values('4', '公共空间清洁', '4', '次', '40.00', '', '要时刻观察老人状态', '0', 'admin', sysdate(), '', null, '');
insert into nursing_project values('5', '洗头', '5', '次', '35.50', '', '要时刻观察老人状态', '1', 'admin', sysdate(), '', null, '');
