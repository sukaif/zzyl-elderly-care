  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zzyl:project:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['zzyl:project:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['zzyl:project:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['zzyl:project:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import type { NursingProject, ProjectQueryParams } from "@/types/api/zzyl/project"
import { listProject, getProject, delProject, addProject, updateProject } from "@/api/zzyl/project"
...
function handleExport() {
  proxy.download('zzyl/project/export', {
    ...queryParams.value
